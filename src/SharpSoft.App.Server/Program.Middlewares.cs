...
using System.Web;
using SharpSoft.App.Client.Core.Services;
...
namespace SharpSoft.App.Server;
...
public static partial class Program
{
    ...
    public static void ConfiureMiddlewares(this WebApplication app)
    {
        ...
        var blazorApp = app.MapRazorComponents<SharpSoft.App.Server.Components.App>()
            .AddInteractiveServerRenderMode()
            .AddInteractiveWebAssemblyRenderMode()
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("SharpSoft.App") is true).Except([Assembly.GetExecutingAssembly()]).ToArray());
