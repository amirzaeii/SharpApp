...
using SharpSoft.App.Server.Services;
using SharpSoft.App.Client.Web;
...
public static partial class Program
{
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "SharpSoft.App.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "SharpSoft.App.Shared.xml"));
